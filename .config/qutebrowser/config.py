...
config.bind('<Alt-ě>', 'tab-focus 2')
config.bind('<Alt-š>', 'tab-focus 3')
config.bind('<Alt-č>', 'tab-focus 4')
config.bind('<Alt-ř>', 'tab-focus 5')
config.bind('<Alt-ž>', 'tab-focus 6')
config.bind('<Alt-ý>', 'tab-focus 7')
config.bind('<Alt-á>', 'tab-focus 8')
config.bind('<Alt-í>', 'tab-focus 9')
config.bind('<Alt-é>', 'tab-focus -1')

config.bind('<Alt-g>', 'tab-give')
...
config.bind('<Alt-Shift-o>', 'set-cmd-text -s :open -t')
config.bind('<Alt-b>', 'set-cmd-text -s :quickmark-load')
config.bind('<Alt-Shift-b>', 'set-cmd-text -s :quickmark-load -t')

config.bind('<Alt-w>', 'tab-close')
config.bind('r', 'reload')
config.bind('R', 'reload -f')
config.bind('<Alt-u>', 'undo')
config.bind('<Alt-y>', 'yank;; yank')
...
config.bind('H', 'fake-key <Shift+left>');
config.bind('J', 'fake-key <Shift+down>');
config.bind('K', 'fake-key <Shift+up>');
config.bind('L', 'fake-key <Shift+right>');

# config.bind('<Ctrl+h>', 'fake-key <Ctrl+left>');
config.bind('<Ctrl+j>', 'fake-key <Ctrl+down>');
config.bind('<Ctrl+k>', 'fake-key <Ctrl+up>');
# config.bind('<Ctrl+l>', 'fake-key <Ctrl+right>');

config.bind('i', 'enter-mode insert')
config.bind('a', 'enter-mode insert')

config.bind('b', 'fake-key <Ctrl-left>');
config.bind('e', 'fake-key <Ctrl-right>');
...
config.bind('o', 'fake-key <Ctrl+End>;; fake-key <Enter>;; enter-mode insert');
config.bind('O', 'fake-key <Ctrl+Home>;; fake-key <Enter>;; enter-mode insert');
...
config.bind('<Alt-Shift+h>', 'set-cmd-text :open -t -r https://via.hypothes.is/{url:pretty}');
...
#default is used.
#Type: Directory
c.downloads.location.directory = "/home/adam/downloads"
...
c.editor.command = ['alacritty', '-e', 'kakoune', '{file}']
